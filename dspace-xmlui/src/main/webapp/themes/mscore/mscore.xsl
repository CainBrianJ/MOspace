...
-->
<!--
   mscore is the base theme for the MOspace respository. It imports most of its code directly from the Mirage theme, and overrides only the templates it needs to over^ride.
   Author: Hardy Pottinger (with inspriation from Peter Dietz at Ohio State University and Ivan Masár aka Helix84)
...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:import href="lib/xsl/core/Local.xsl"/>
