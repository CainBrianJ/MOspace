...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHead">
        <head>
            ...
            <!-- hjp: see Local.xsl for buildHeadMOspace -->
            <xsl:call-template name="buildHeadMOspace"/>
            <!-- Add global theme(s) -->
            <link rel="stylesheet" type="text/css">
                <xsl:attribute name="href">
                    <xsl:value-of select="$context-path"/>
                    <xsl:text>/static/css/mospace_base.css</xsl:text>
                </xsl:attribute>
            </link>
            <!-- Add stylsheets -->
            ...
            <!-- link the UM stylesheet for identity purposes (linked instead of embedded to ease maintenance) -->
            <link href="/umsbar.css" rel="stylesheet" type="text/css" />
    ...
    <xsl:template name="buildHeader">
                ...
                <!-- BEGIN: UMS Header Bar -->
                <div class="umsheader">
                        <div class="umsheaderlogo"><a href="http://www.umsystem.edu/">

                <img class="umsheaderlink" alt="Link to University of Missouri System home page">
                    <xsl:attribute name="src">
                        <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='contextPath'][not(@qualifier)]"/>
                        <xsl:text>/themes/</xsl:text>
                        <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='theme'][@qualifier='path']"/>
                        <xsl:text>/../../static/images/blank.gif</xsl:text>
                    </xsl:attribute>
                </img>
                            </a>
                        </div>

			<!-- Move the ds-user-box (aka the login and profile link) to the UMS Header Bar -->
            <xsl:choose>
        ...
        <div id="ds-footer">
            ...
            <div id="ds-footer-links">
               ...
               <xsl:text> | hosted by </xsl:text>
                <a>
                    <xsl:attribute name="href">
                        <xsl:text>http://lso.umsystem.edu/</xsl:text>
                    </xsl:attribute>
            ...
            <!--Invisible link to HTML sitemap (for search engines) -->
				...
				<!-- add awstats_misc_tracker.js here -->
